package be.intecbrussel.healthy_goal.config.oauth;

import be.intecbrussel.healthy_goal.config.oauth.user.OAuth2UserInfo;
import be.intecbrussel.healthy_goal.config.oauth.user.OAuth2UserInfoFactory;
